...
import { InsufficientCreditsModal } from './InsuficientCreditModal';
                ...
                >
                  ...
                  <SelectContent>
                    {Object.keys(aspectRatioOptions).map( ratio =>(
                      <SelectItem key={ratio} value={ratio} className='select-item'>{aspectRatioOptions[ratio as AspectRatioKey].label}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
              )}
